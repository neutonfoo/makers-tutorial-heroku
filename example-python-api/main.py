...
def person_of_nationality():
    ...
    person_json = requests.get('https://randomuser.me/api', params={"nat":nationality}).json()
...
def people():
    ...
    person_json = requests.get('https://randomuser.me/api', params={"results":number_of_people}).json()
